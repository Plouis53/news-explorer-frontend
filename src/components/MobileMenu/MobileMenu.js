      ...
      <div className={`menu__container-${loggedIn}`}>
        <div className="menu__over">
          ...
          <button type="button" className="menu__button" aria-label="Close">
            <img className="menu__close" alt="Close button" src={closeIcon} onClick={closeModal} />
          </button>
        </div>
        ...
        {isLoggedIn ? (
          <>
            ...
            <button className="menu__signout-button" onClick={handleSignoutClick}>
              {userData.name}
              <img src={logout} alt="Signout Button" className="menu__signout-image" />
            </button>
          </>
        ) : (
